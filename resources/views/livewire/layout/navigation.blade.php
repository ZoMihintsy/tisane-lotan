...
<nav x-data="{ open: false }" class="bg-3d-green-radial text-brown dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('t.category')" class="text-brown" :active="request()->routeIs('t.category')" wire:navigate>
                        {{ __('Categorie') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('t.produit')" class="text-brown" :active="request()->routeIs('t.produit')" wire:navigate>
                        {{ __('Ajoute de produit') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('t.point')" class="text-brown" :active="request()->routeIs('t.point')" wire:navigate>
                        {{ __('Point de vente') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('t.points')" class="text-brown" :active="request()->routeIs('t.points')" wire:navigate>
                        {{ __('Les points de vente') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('commande')" class="text-brown-dark" :active="request()->routeIs('commande')" wire:navigate>
                        {{ __('Commandes') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('commentaire')" class="text-brown-dark" :active="request()->routeIs('commentaire')" wire:navigate>
                        {{ __('Commentaires') }}
                    </x-responsive-nav-link>
                </div>
